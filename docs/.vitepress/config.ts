...
const v14EnSidebar = [
  {
    ...
    items: [
      ...
      {
        text: "Understanding Thought Relationships",
        link: "/v14/en/Understanding-Thought-Relationships",
      },
      { text: "Navigating Your Brain", link: "/v14/en/Navigating-Your-Brain" },
      {
        text: "Customizing Your Brain's Environment",
        link: "/v14/en/Customizing-Your-Brains-Environment",
      },
      { text: "Creating Thoughts", link: "/v14/en/Creating-Thoughts" },
      {
        text: "Editing Thoughts and Links",
        link: "/v14/en/Editing-Thoughts-and-Links",
      },
      {
        text: "Customizing Thought and Link Properties",
        link: "/v14/en/Customizing-Thought-and-Link-Properties",
      },
      {
        text: "Advanced Navigation and Alternative Views",
        link: "/v14/en/Advanced-Navigation-and-Alternative-Views",
      },
      ...
      {
        text: "Using Mobile Versions of TheBrain",
        link: "/v14/en/Using-Mobile-Versions-of-TheBrain",
      },
      {
        text: "Share, Synchronize, and Back Up Your Brains",
        link: "/v14/en/Share-Synchronize-and-Back-Up-Your-Brains",
      },
      {
        text: "Importing Information into Your Brain",
        link: "/v14/en/Importing-Information-into-Your-Brain",
      },
      {
        text: "Encrypting Individual File Attachments",
        link: "/v14/en/Encrypting-Individual-File-Attachments",
      },
...
const v15EnSidebar = [
  {
    text: "User Guide (v15)",
    items: [{ text: "Overview", link: "/v15/en/" }],
  },
];
...
const userCasesEnSidebar = [
  {
    text: "User Cases",
    items: [{ text: "Overview", link: "/user-cases/en/" }],
  },
];
...
const userCasesZhSidebar = [
  {
    text: "用户案例",
    items: [{ text: "概述", link: "/user-cases/zh/" }],
  },
];
...
const userCasesZhTWSidebar = [
  {
    text: "用戶案例",
    items: [{ text: "概述", link: "/user-cases/zh-TW/" }],
  },
];
...
const brainMapsEnSidebar = [
  {
    text: "Brain Maps",
    items: [{ text: "Gallery", link: "/brain-maps/en/" }],
  },
];
...
const brainMapsZhSidebar = [
  {
    text: "精选脑图",
    items: [{ text: "展示", link: "/brain-maps/zh/" }],
  },
];
...
const brainMapsZhTWSidebar = [
  {
    text: "精選腦圖",
    items: [{ text: "展示", link: "/brain-maps/zh-TW/" }],
  },
];
...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/tobemaster56/the-brain-guide",
      },
    ],
  },
  sitemap: {
